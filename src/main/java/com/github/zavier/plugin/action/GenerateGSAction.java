...
// need extends AnAction
// @see https://gitee.com/cttcu/IDEA-Plugins/blob/master/generateGSDoc/src/com/ctt/format/GenerateGSAction.java
public class GenerateGSAction {
